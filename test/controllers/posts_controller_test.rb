...
class PostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update post" do
    patch post_url(@post), params: { post: { body: @post.body, comment_enabled: @post.comment_enabled, important: @post.important, summary: @post.summary, title: @post.title, user_id: @post.user_id } }
